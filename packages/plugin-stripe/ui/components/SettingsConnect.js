...
/*
  ...
  <a href={`https://connect.stripe.com/oauth/authorize?response_type=code&state=${siteData.id}&client_id=${stripeClientId}&scope=read_write`}>
          <img src='/assets/images/stripe-connect.png' />
        </a>
